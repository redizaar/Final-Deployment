...
namespace WpfApp1
{
    public class TemplateStockReadIn
    {
        ...
        private void getHistoricalStockPrice(int companyColumn, int dateColumn)
        {
            ...
            */
            string path = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"companylist.csv");
            IEnumerable<String> all_lines = System.IO.File.ReadLines(path, Encoding.Default);
